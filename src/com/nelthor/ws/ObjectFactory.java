 ...
 * generated in the com.nelthor.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operacion_QNAME = new QName("http://ws.nelthor.com/", "operacion");
    private final static QName _OperacionResponse_QNAME = new QName("http://ws.nelthor.com/", "operacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.nelthor.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.nelthor.com/", name = "operacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.nelthor.com/", name = "operacionResponse")
